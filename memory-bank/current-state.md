...
- It builds a playable vertical slice across `town:temple`, `town:square`, `town:market`, `town:gate`, `forest:edge`, `forest:path`, and `town:tavern`.
...
- The scene is a compact market street with side shopfronts, awnings, merchant stalls, a market cart, crates/barrels, weapon rack, armor display, and a forge focal point.
...
- `scripts/test-neomud-three-room-shots.cjs` captures fixed authored-room screenshot anchors for Temple nave/altar, Town Square plaza, Market Street entry/forge, North Gate entry/forest road, Forest Edge entry/path, Forest Path entry/fork, and Tavern entry/bar, then writes `room-shots-report.json`.
- The offline smoke test checks rendered triangles, avatar initialization, run animation activation, stable grounded Y with no procedural walk bob, default room data, forward movement, diagonal/strafe movement, jump/landing, Temple/Tavern collision pushout, Town Square/Market Street/North Gate/Forest Edge/Forest Path trigger/prompt/affordance metadata, physical room movement, console errors, and failed HTTP requests.
...
- Latest offline smoke reports Temple 280 calls / 35,006 triangles / 6 textures / 196 geometries; Town Square 228 calls / 15,508 triangles / 19 textures / 164 geometries; Market Street 121 calls / 4,276 triangles / 24 textures / 63 geometries; North Gate 36 calls / 3,362 triangles / 27 textures / 29 geometries; Forest Edge 42 calls / 4,414 triangles / 30 textures / 36 geometries; Forest Path 44 calls / 4,840 triangles / 34 textures / 34 geometries; Tavern 106 calls / 6,872 triangles / 36 textures / 59 geometries.
- Latest server-backed QA reports Temple 280 calls / 35,006 triangles / 6 textures / 196 geometries; Town Square 228 calls / 15,508 triangles / 19 textures / 164 geometries; Market Street 121 calls / 4,276 triangles / 23 textures / 63 geometries; North Gate 36 calls / 3,362 triangles / 27 textures / 29 geometries; Forest Edge 42 calls / 4,414 triangles / 29 textures / 36 geometries; Forest Path 38 calls / 3,012 triangles / 31 textures / 30 geometries; Tavern 105 calls / 6,860 triangles / 34 textures / 59 geometries.
...
- Latest authored-room screenshot QA reports Temple 259 calls / 33,516 triangles / 6 textures / 196 geometries; Town Square 220 calls / 15,432 triangles / 19 textures / 164 geometries; Market Street 121 calls / 4,276 triangles / 23 textures / 63 geometries; North Gate 36 calls / 3,362 triangles / 26 textures / 29 geometries; Forest Edge 42 calls / 4,414 triangles / 28 textures / 36 geometries; Forest Path 44 calls / 4,840 triangles / 32 textures / 34 geometries; Tavern 106 calls / 6,872 triangles / 34 textures / 59 geometries, with no console errors or failed requests.
