...
- It builds a playable vertical slice across `town:temple`, `town:square`, `town:market`, `town:magic_shop`, `town:gate`, `forest:edge`, `forest:path`, and `town:tavern`.
...
- `scripts/test-neomud-three-room-shots.cjs` captures fixed authored-room screenshot anchors for Temple nave/altar, Town Square plaza, Market Street entry/forge, Magic Shop entry/counter, North Gate entry/forest road, Forest Edge entry/path, Forest Path entry/fork, and Tavern entry/bar, then writes `room-shots-report.json`.
- The offline smoke test checks rendered triangles, avatar initialization, run animation activation, stable grounded Y with no procedural walk bob, default room data, forward movement, diagonal/strafe movement, jump/landing, Temple/Tavern collision pushout, Town Square/Market Street/Magic Shop/North Gate/Forest Edge/Forest Path trigger/prompt/affordance metadata, physical room movement, console errors, and failed HTTP requests.
...
- `scripts/test-neomud-three-server.cjs` runs the server-backed browser test. It requires the Kotlin server on `127.0.0.1:8080`, waits for guest auth, verifies Temple sync, crosses physical exit triggers for Temple -> Town Square -> Market Street -> Magic Shop -> Market Street -> Town Square -> North Gate -> Forest Edge -> Forest Path -> Forest Edge -> North Gate -> Town Square -> Tavern -> Town Square -> Temple, asserts server-confirmed room transitions, and verifies visible entities mirror the live server NPC list instead of falling back to static hostile NPC placements.
...
- Latest offline smoke reports Temple 280 calls / 35,006 triangles / 6 textures / 196 geometries; Town Square 228 calls / 15,508 triangles / 19 textures / 164 geometries; Market Street 131 calls / 6,340 triangles / 24 textures / 73 geometries; Magic Shop 56 calls / 6,306 triangles / 28 textures / 47 geometries; North Gate 36 calls / 3,362 triangles / 31 textures / 29 geometries; Forest Edge 42 calls / 4,414 triangles / 34 textures / 36 geometries; Forest Path 44 calls / 4,840 triangles / 38 textures / 34 geometries; Tavern 106 calls / 6,872 triangles / 40 textures / 59 geometries.
- Latest server-backed QA reports Temple 280 calls / 35,006 triangles / 6 textures / 196 geometries; Town Square 228 calls / 15,508 triangles / 19 textures / 164 geometries; Market Street 131 calls / 6,340 triangles / 23 textures / 73 geometries; Magic Shop 56 calls / 6,306 triangles / 27 textures / 47 geometries; North Gate 36 calls / 3,362 triangles / 31 textures / 29 geometries; Forest Edge 39 calls / 3,500 triangles / 32 textures / 33 geometries; Forest Path 41 calls / 3,926 triangles / 35 textures / 32 geometries; Tavern 105 calls / 6,860 triangles / 38 textures / 59 geometries.
...
- Latest authored-room screenshot QA reports Temple 259 calls / 33,516 triangles / 6 textures / 196 geometries; Town Square 220 calls / 15,432 triangles / 19 textures / 164 geometries; Market Street 131 calls / 6,340 triangles / 23 textures / 73 geometries; Magic Shop 56 calls / 6,306 triangles / 27 textures / 47 geometries; North Gate 36 calls / 3,362 triangles / 30 textures / 29 geometries; Forest Edge 42 calls / 4,414 triangles / 32 textures / 36 geometries; Forest Path 44 calls / 4,840 triangles / 36 textures / 34 geometries; Tavern 106 calls / 6,872 triangles / 38 textures / 59 geometries, with no console errors or failed requests.
