...
- The Temple runtime now adds a small room-specific light rig on top of the GLB package: warm altar key, cool nave/entry fill, subtle side-window fill, and transparent depth handling for floor-light meshes. This is still a JavaScript rig and should eventually be reconciled with authored `LIGHTS_` markers.
