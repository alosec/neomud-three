...
- Blender 5.1.2 is now installed locally and the fork has a first Blender/GLB authoring pipeline. The initial movement gym source scene is `experiments/neomud-three/assets/source/levels/movement_gym.blend`; its exported runtime GLB is `experiments/neomud-three/assets/build/levels/movement_gym.glb`. `scripts/validate-neomud-three-gltf.mjs` validates required object prefixes and exported custom properties before runtime integration.
- `experiments/neomud-three/level-loader.js` now loads Blender-authored GLBs through Three.js `GLTFLoader`, classifies `VIS_`, `COL_`, `NAV_`, `SPAWN_`, `TRG_`, `PICKUP_`, `ENEMY_`, `PATH_`, `CAMERA_`, and `LIGHTS_` nodes, hides non-render authoring/gameplay nodes, and exposes typed metadata. `movement-gym.html` is the first runtime review page for this parser.
- The Movement Gym review page now renders debug geometry directly from that parsed GLB metadata: collision boxes, trigger volume, spawn/pickup/enemy/light markers, patrol path, and camera zone. The lab QA asserts both parser counts and debug-layer counts.
...
- The Blender movement gym is loaded by a lab page and has parsed-metadata debug drawing, but it is not yet integrated into the main room runtime, movement controller, collision system, or server-backed room graph. The next architecture pass should make the parser/debug output reusable by the main renderer.
...
- `scripts/validate-neomud-three-gltf.mjs` parses exported GLB files directly, checks the first Blender movement gym is glTF 2.0, verifies required authoring prefixes are present, and asserts spawn/trigger/collision/path/pickup custom properties were exported into glTF extras.
...
- Latest offline smoke reports Temple 290 calls / 35,526 triangles / 6 textures / 202 geometries; Town Square 210 calls / 21,004 triangles / 19 textures / 161 geometries; Market Street 132 calls / 6,462 triangles / 24 textures / 73 geometries; Magic Shop 57 calls / 6,428 triangles / 28 textures / 47 geometries; Forge 57 calls / 4,088 triangles / 31 textures / 45 geometries; North Gate 36 calls / 3,482 triangles / 34 textures / 29 geometries; Forest Edge 42 calls / 4,534 triangles / 37 textures / 36 geometries; Forest Path 44 calls / 4,960 triangles / 41 textures / 34 geometries; Deep Forest 45 calls / 3,638 triangles / 45 textures / 34 geometries; Hidden Cave 53 calls / 3,045 triangles / 48 textures / 44 geometries; Sunlit Clearing 44 calls / 4,405 triangles / 50 textures / 34 geometries; Tavern 89 calls / 9,026 triangles / 53 textures / 66 geometries.
- Latest server-backed QA reports Temple 290 calls / 35,526 triangles / 6 textures / 202 geometries; Town Square 210 calls / 21,004 triangles / 19 textures / 161 geometries; Market Street 132 calls / 6,462 triangles / 23 textures / 73 geometries; Magic Shop 57 calls / 6,428 triangles / 27 textures / 47 geometries; Forge 57 calls / 4,088 triangles / 30 textures / 45 geometries; North Gate 36 calls / 3,482 triangles / 34 textures / 29 geometries; Forest Edge 42 calls / 4,534 triangles / 36 textures / 36 geometries; Forest Path 41 calls / 4,046 triangles / 39 textures / 32 geometries; Deep Forest 43 calls / 3,634 triangles / 43 textures / 34 geometries; Hidden Cave 53 calls / 3,045 triangles / 46 textures / 44 geometries; Sunlit Clearing 47 calls / 5,185 triangles / 48 textures / 37 geometries; Tavern 88 calls / 9,014 triangles / 52 textures / 66 geometries.
...
- Latest authored-room screenshot QA reports Temple 269 calls / 34,036 triangles / 6 textures / 202 geometries; Town Square 207 calls / 20,988 triangles / 19 textures / 161 geometries; Market Street 132 calls / 6,462 triangles / 23 textures / 73 geometries; Magic Shop 57 calls / 6,428 triangles / 27 textures / 47 geometries; Forge 57 calls / 4,088 triangles / 30 textures / 45 geometries; North Gate 36 calls / 3,482 triangles / 33 textures / 29 geometries; Forest Edge 42 calls / 4,534 triangles / 35 textures / 36 geometries; Forest Path 44 calls / 4,960 triangles / 39 textures / 34 geometries; Deep Forest 45 calls / 3,638 triangles / 43 textures / 34 geometries; Hidden Cave 53 calls / 3,045 triangles / 46 textures / 44 geometries; Sunlit Clearing 44 calls / 4,405 triangles / 48 textures / 34 geometries; Tavern 89 calls / 9,026 triangles / 51 textures / 66 geometries, with no console errors or failed requests.
