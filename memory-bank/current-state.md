...
- `experiments/neomud-three/glb-room-runtime.js` now turns a parsed GLB room package into the standard playable room runtime contract: spawn, bounds clamp, GLB-derived collider pushout, physical exit triggers, debug colliders, debug triggers, and package landmark metadata. Temple and Tavern use this adapter instead of local room-specific GLB parsing glue.
...
- `memory-bank/asset-level-qa-workflow.md` now defines the corrective workflow for cathedral fixtures: isolated Blender source/export, browser asset-lab QA, then room integration only after the fixture proves itself. Current accepted playable-prototype candidates are `cathedral.pew`, `cathedral.wall_window_bay`, and `cathedral.altar_incense_fixture`.
...
- The latest fixture passes remove the obstructing freestanding side-pier/lintel geometry that sat visually in front of stained-glass windows, replace it with shallow wall ribs, upgrade pews through an isolated `cathedral.pew` candidate, replace colored side-window slabs with an isolated `cathedral.wall_window_bay` candidate, and replace the flat altar blockout with the isolated `cathedral.altar_incense_fixture` candidate. Temple visible meshes are now batched by material during Blender export, keeping the richer Temple GLB at 33 render calls in authored-room screenshot QA.
...
- The current GLB art is still low-poly and not final cathedral art. The next Temple pass should continue fixture-level QA on material/lighting quality, stained-glass texture fidelity, and nave composition rather than returning to broad room-wide mesh construction.
...
- `scripts/test-neomud-three-labs.cjs` also screenshots `cathedral-asset-lab.html` and asserts the isolated `cathedral.pew` candidate has separate backrest/end-panel render nodes plus a collider footprint, that `cathedral.wall_window_bay` has arched frame, mullion, inset glass, and collider metadata, and that `cathedral.altar_incense_fixture` has arched re-table, dawn medallion, incense bowls, smoke geometry, and collider metadata.
...
- Latest offline smoke after the Blender Tavern migration reports Temple 220 calls / 4,656 triangles / 1 texture / 171 geometries; Town Square 211 calls / 21,280 triangles / 15 textures / 161 geometries; Market Street 133 calls / 6,738 triangles / 21 textures / 73 geometries; Magic Shop 58 calls / 6,704 triangles / 25 textures / 47 geometries; Forge 58 calls / 4,364 triangles / 28 textures / 45 geometries; North Gate 37 calls / 3,758 triangles / 31 textures / 29 geometries; Forest Edge 43 calls / 4,810 triangles / 34 textures / 36 geometries; Forest Path 45 calls / 5,236 triangles / 38 textures / 34 geometries; Deep Forest 46 calls / 3,914 triangles / 42 textures / 34 geometries; Hidden Cave 54 calls / 3,321 triangles / 45 textures / 44 geometries; Sunlit Clearing 45 calls / 4,681 triangles / 47 textures / 34 geometries; Tavern 30 calls / 6,882 triangles / 48 textures / 21 geometries.
- Latest server-backed QA reports Temple 220 calls / 4,656 triangles / 1 texture / 171 geometries; Town Square 211 calls / 21,280 triangles / 15 textures / 161 geometries; Market Street 133 calls / 6,738 triangles / 19 textures / 73 geometries; Magic Shop 58 calls / 6,704 triangles / 23 textures / 47 geometries; Forge 58 calls / 4,364 triangles / 26 textures / 45 geometries; North Gate 37 calls / 3,758 triangles / 31 textures / 29 geometries; Forest Edge 40 calls / 3,896 triangles / 32 textures / 33 geometries; Forest Path 42 calls / 4,322 triangles / 35 textures / 32 geometries; Deep Forest 44 calls / 3,910 triangles / 39 textures / 34 geometries; Hidden Cave 54 calls / 3,321 triangles / 42 textures / 44 geometries; Sunlit Clearing 48 calls / 5,461 triangles / 44 textures / 37 geometries; Tavern 30 calls / 6,882 triangles / 47 textures / 21 geometries.
...
- Latest authored-room screenshot QA after the Blender Tavern migration reports Temple 212 calls / 4,512 triangles / 1 texture / 171 geometries; Town Square 208 calls / 21,264 triangles / 15 textures / 161 geometries; Market Street 133 calls / 6,738 triangles / 19 textures / 73 geometries; Magic Shop 58 calls / 6,704 triangles / 23 textures / 47 geometries; Forge 58 calls / 4,364 triangles / 26 textures / 45 geometries; North Gate 37 calls / 3,758 triangles / 29 textures / 29 geometries; Forest Edge 43 calls / 4,810 triangles / 31 textures / 36 geometries; Forest Path 45 calls / 5,236 triangles / 35 textures / 34 geometries; Deep Forest 46 calls / 3,914 triangles / 39 textures / 34 geometries; Hidden Cave 54 calls / 3,321 triangles / 42 textures / 44 geometries; Sunlit Clearing 45 calls / 4,681 triangles / 44 textures / 34 geometries; Tavern 30 calls / 6,882 triangles / 45 textures / 21 geometries, with no console errors or failed requests.
...
- Latest Cathedral Asset Lab QA reports 155 draw calls, 2,448 triangles, 7 textures, 142 geometries, no console errors, no failed requests, and a passing budget report for the `cathedral.pew` and `cathedral.wall_window_bay` candidates.
