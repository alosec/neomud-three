...
- The current GLB art is intentionally first-pass and low-poly. It proves the production workflow, not final cathedral art. The next Temple pass should refine mesh proportions, material IDs, authored lighting, and GLB-driven debug visualization rather than returning to runtime mesh construction.
