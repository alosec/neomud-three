...
8. Next concrete visual pass.
   ...
   - Forest Edge is now an authored room with Forest Rat, South/North physical triggers, lightweight tree/log/stone collision, and server-backed traversal. Further Forest work should integrate the flat backdrop with depth cards/foreground trees and improve forest material/lighting rather than blindly expanding room count.
