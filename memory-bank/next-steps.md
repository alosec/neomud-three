...
8. Next concrete visual pass.
   ...
   - The Tavern Barkeep staging pass adds a service spot, Barkeep board, tap handles, tray/ledger details, and warm service light; future Tavern work should avoid spending many more draw calls before the Tavern budget is widened or optimized.
