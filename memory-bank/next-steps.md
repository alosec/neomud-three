...
8. Next concrete visual pass.
   ...
   - The south Temple forecourt now has spec-driven sun inlays, offering plinths, candle rows, low rails, and plinth collision. Further Temple-front work should reclaim Town Square draw-call headroom first because full-smoke Town Square is now close to its 240-call budget.
