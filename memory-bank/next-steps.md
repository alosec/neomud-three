...
8. Next concrete visual pass.
   ...
   - The courtyard garden composition pass adds larger main-ground tree clusters with oval garden beds, shrubs, and flowers through `TOWN_SQUARE_SPEC`; further warmth work should improve landmark-specific story dressing instead of adding more generic greenery.
