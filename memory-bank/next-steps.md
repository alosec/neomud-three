...
8. Next concrete visual pass.
   ...
   - Hidden Cave is now an authored room with an east return to Deep Forest, moss-covered chest affordance from NeoMud world data, collision, fixed screenshots, offline smoke, server-backed traversal, and a live `interact_feature` bridge for the chest. Further Hidden Cave work should refine the cave walls/ceiling composition and make dropped treasure/inventory changes more legible in-world.
