...
def build_level():
    ...
    wood_dark = material("MAT_temple_pew_dark_endgrain", (0.22, 0.14, 0.08, 1), roughness=0.88)
    wood_highlight = material("MAT_temple_pew_worn_edge", (0.44, 0.30, 0.16, 1), roughness=0.78)
